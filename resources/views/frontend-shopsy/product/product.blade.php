                ...
                <div class="col-xxl-12">
                    <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list has-icon">
                            ...
                            <span style="color: #008194;"><a
                                    href="{{route('front.product',$product->slug)}}">{{$product->title}}</a></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tp-product-details-thumb-slider p-relative">
                            <div class="tp-product-details-thumb-slider-active swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div
                                        class="tp-prouct-details-thumb-item w-img swiper-slide {{($key == 0) ? 'active' : ''}}">
                        ...
                        <div class="tp-product-details-wrapper">
                            ...
                            <div class="tp-product-details-action-wrapper">
                                ...
                                {{-- <a href="javascript:void(0);" onclick="addToCart({{$product->id}})">
                                    <button class="tp-product-details-buy-now-btn w-100 mt-5">Add to Cart</button>
                                </a> --}}
                            ...
                            {{-- <div class="tp-product-details-social"> --}}
                                ...
                                <a href="https://api.whatsapp.com/send?phone=917865006370" target="blank"><i
                                            ...
                                            <div class="tp-product-item-2 mb-40">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                    <div class="tp-product-tag-2">
                                                        <a href="{{route('front.shop',$relProduct->product_category->slug)}}">{{$relProduct->product_category->name}}</a>
                                                     </div>
                                                    ...
                                                    <div class="tp-product-price-wrapper-2">
                                                        ...
                                                        <span class="tp-product-price-2 old-price">₹
                                                            {{$relProduct->compare_price}}</span>

                                                        @endif
                                                    </div>

                                                    <a href="https://api.whatsapp.com/send?phone=917001639863"
                                                        target="_blank">
