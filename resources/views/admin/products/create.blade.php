                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="dimensions" id="dimensions"
                                                    class="form-control" placeholder="Product Dimensions ( W X H X L )">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="rain_cover">Is rain Cover Available?</label>
                                                <input type="text" name="rain_cover" id="rain_cover"
                                                    class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="laptop_compatibility"
                                                    id="laptop_compatibility" class="form-control"
