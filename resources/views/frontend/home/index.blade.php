        ...
        <div class="custom-container">
            <div class="row">
                ...
                <div class="col-lg-2 d-none d-lg-block">
                    <div class="shop_banner2 ">
                        <img src="{{ asset('assets/images/apex/gal-pic-1.jpg') }}" alt="shop_banner_img7">
                    ...
                    <div class="shop_banner2 ">
                        <img src="{{ asset('assets/images/apex/gal-pic-4.jpg') }}" alt="shop_banner_img7">
                        {{-- <a href="#" class="hover_effect1">
                            <div class="el_title text_white">
                                <h6>Get Your Luggage Now</h6>
                                <span><u>Shop Now</u></span>
                                <h6>Upto 39% off</h6>

                            </div>
                            <div class="el_img">
                                <img src="{{ asset('assets/images/apex/home-right-2.webp') }}" alt="shop_banner_img7"
                                    width="120px">
                            </div>
                        </a> --}}
                    </div>
                                    ...
                                    @if ($products->isNotEmpty())
                                        @foreach ($products as $product)
                                            ...
                                            @php
                                                ...
                                                $secondProductImage = $productImagehover->count() > 1 ? $productImagehover->skip(1)->first() : null;
                                            @endphp
                                                ...
                                                <div class="product_wrap">
                                                    ...
                                                    <div class="product_info">
                                                        <h6 class="product_title"><a
                                                                href="{{ route('front.product', $product->slug) }}">Apex
                                                                #{{ $product->title }}</a>
                                                        </h6>
                                                        <a href="{{ route('front.product', $product->slug) }}">
                                                            <div class="product_price">
                                                                ...
                                                                @endif
                                                                <div class="on_sale">
                                                                    <span>{{ round((($product->compare_price - $product->price) / $product->compare_price) * 100), 1 }}%
                                                                        Off</span>
                                                                </div>
                                                            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 d-none d-xl-block">
                        <div class="sale-banner">
                            <a class="hover_effect1" href="{{ url('/shop') }}">
                                <img src="{{ asset('assets/images/apex/home-desktop-side2.webp') }}"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="heading_tab_header">
                                    ...
                                    <div class="view_all">
                                        <a href="{{ url('/shop') }}" class="text_default"><i
