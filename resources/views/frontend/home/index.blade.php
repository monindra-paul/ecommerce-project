...
<main>
        ...
        <div class="swiper h7_slider-active">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="h7_single-banner bg-default" data-background="{{asset('assets/img/enroot/slider-11.webp')}}">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-11">
                                    <div class="h7_banner-content">
                                        <h1 class="h7_banner-content-title" data-animation="fadeInUp" data-delay="0.3s">Welcome to 
                                         Enroot Abacus</h1>
                                        {{-- <p class="h7_banner-content-text" data-animation="fadeInUp" data-delay="0.5s">Cosmic is committed to providing learning opportunities tailored to support emerging career opportunities.</p> --}}
                                        <div class="h7_banner-content-btn" data-animation="fadeInUp" data-delay="0.7s">
                                            <a href="{{url('/about-us')}}" class="theme-btn theme-btn-7">About Us<i class="fa-light fa-arrow-right"></i></a>
                ...
                <div class="swiper-slide">
                    <div class="h7_single-banner bg-default" data-background="{{asset('assets/img/enroot/slider-2.webp')}}">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-11">
                                    <div class="h7_banner-content">
                                        ...
                                        {{-- <p class="h7_banner-content-text" data-animation="fadeInUp" data-delay="0.5s">Cosmic is committed to providing learning opportunities tailored to support emerging career opportunities.</p> --}}
                                        <div class="h7_banner-content-btn" data-animation="fadeInUp" data-delay="0.7s">
                                            <a href="{{url('/courses/vedic-math')}}" class="theme-btn theme-btn-7">Know More About Us<i class="fa-light fa-arrow-right"></i></a>
                                            {{-- <a href="#" class="theme-btn theme-btn-7 theme-btn-7-yellow">Learn More<i class="fa-light fa-arrow-right"></i></a> --}}
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="swiper-slide">
                    <div class="h7_single-banner bg-default" data-background="{{asset('assets/img/enroot/1.jpg')}}">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-11">
                                    <div class="h7_banner-content">
                                        ...
                                        {{-- <p class="h7_banner-content-text" data-animation="fadeInUp" data-delay="0.5s">Cosmic is committed to providing learning opportunities tailored to support emerging career opportunities.</p> --}}
                                        <div class="h7_banner-content-btn" data-animation="fadeInUp" data-delay="0.7s">
                                            <a href="{{url('/courses/vedic-math')}}" class="theme-btn theme-btn-7">Know More<i class="fa-light fa-arrow-right"></i></a>
                                            {{-- <a href="#" class="theme-btn theme-btn-7 theme-btn-7-yellow">Learn More<i class="fa-light fa-arrow-right"></i></a> --}}
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="h7_slider-thumb">
        <div class="swiper h7_slider-active-nav">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="h7_slider-thumb-item" data-background="{{asset('assets/img/banner/7/thumb-1.jpg')}}">
                        ...
                        <div class="h7_slider-thumbs-info">
                            <h4>Abacus Training</h4>
                            <a href="{{url('courses/abacus')}}">Read More<i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="h7_slider-thumb-item" data-background="{{asset('assets/img/banner/7/thumb-2.jpg')}}">
                        <div class="h7_slider-thumbs-icon">
                        ...
                        <div class="h7_slider-thumbs-info">
                            ...
                            <a href="{{url('courses/vedic-math')}}">Read More<i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="h7_slider-thumb-item" data-background="{{asset('assets/img/banner/7/thumb-3.jpg')}}">
                        <div class="h7_slider-thumbs-icon">
                        ...
                        <div class="h7_slider-thumbs-info">
                            <h4>Chess Training</h4>
                            <a href="#">Read More<i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="h7_slider-thumb-item" data-background="{{asset('assets/img/banner/7/thumb-4.jpg')}}">
                        <div class="h7_slider-thumbs-icon">
                        ...
                        <div class="h7_slider-thumbs-info">
                            <h4>Kids Program</h4>
                            <a href="{{url('/about-us')}}">Read More<i class="fa-light fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pt-110 pb-50">
        <!-- brand area start -->
        <div class="brand-area h6_brand-area ">
            <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/h_1.png" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/1.png" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/h_2.png" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/2.png" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/h_3.png" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/3.png" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/h_4.png" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/4.png" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/h_5.png" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/5.png" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <a href="#">
                                        <img src="assets/img/brand/h_6.png" alt="" class="brand-hover-img">
                                        <img src="assets/img/brand/6.png" alt="" class="brand-main-img">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="h10_about-img mr-25">
                        <img src="assets/img/about/10/img-shape.png" alt=""
                            class="h10_about-img-shape d-none d-md-block">
                        <img src="assets/img/about/10/shape-1.png" alt=""
                            class="h10_about-img-shape-1 d-none d-md-block">
                        <img src="assets/img/enroot/h-22.png" alt="" class="wow fadeInLeftBig" data-wow-delay="0.3s">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="h10_about-content ml-35">
                        <img src="assets/img/about/10/shape-2.png" alt="" class="h10_about-shape-2">
                        <h2 class="h10_about-content-title">Master the Abacus: <br> A Comprehensive Beginner's Guide</h2>
                        <div class="h10_about-content-inner">
                            <h5>Play As You Learn</h5>
                            <p>We Enroot Abacus Pvt. Ltd. uphold the ethos and values of Ancient Indian Mathematics interacted with the science, knowledge and technology leading to creation of fastest cumulative students who could perform at any circumstances. By offering effective mentoring, psychometric analysis, visualization practices, and focussed attention on every individual student by faculty members of EAPL.</p>
                        </div>
                        ...
                        <div class="h10_about-bottom">
                            <div class="h10_about-admin">
                                <img src="assets/img/enroot/suk-h.webp" alt="" width="border-radius:10px">
                                <div class="h10_about-admin-info">
                                    <h5>Mr. Suklambar Mitra</h5>
                                    <span>Executive Director, Enroot Abacus Pvt. Ltd.</span>
                                </div>
                            </div>
                            <div class="h10_about-bottom-btn">
                                <a href="{{url('/about-us')}}"><span class="inner-btn"><i class="fa-light fa-arrow-up"></i></span><span
                                        class="inner-text">More About Us</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="h8_counter-item justify-content-center mb-25">
                        <div class="h8_counter-info">
                            ...
                            <h3 class="h8_counter-info-title">
                                <span class="odometer count_one" data-count="27256+">00</span><span>+</span>
                            </h3>
                            <span class="h8_counter-info-text">Happy Student</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                    <div class="h8_counter-item justify-content-center mb-25">
                        <div class="h8_counter-info">
                            ...
                            <h3 class="h8_counter-info-title">
                                <span class="odometer count_one" data-count="400+">00</span><span>+</span>
                            </h3>
                            <span class="h8_counter-info-text">Happy Partner's</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                    <div class="h8_counter-item justify-content-center mb-25">
                        <div class="h8_counter-info">
                            ...
                            <span class="h8_counter-info-text">International Students</span>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                    <div class="h8_counter-item justify-content-center mb-25">
                        <div class="h8_counter-info">
                            ...
                            <span class="h8_counter-info-text">Best Awards</span>
                        </div>
                    </div>
                </div> --}}
            </div>
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="h10_course-item mb-30">
                                    <div class="h10_course-item-top">
                                        <div class="h10_course-item-img">
                                            <a href="{{url('courses/abacus')}}"><img src="assets/img/course/10/2.jpg"
                                                    alt=""></a>
                                            <div class="h10_course-item-img-price">
                                                <span>Enroot Abacus</span>
                                            </div>
                                        </div>
                                        <div class="h10_course-content">
                                            <div class="d-flex flex-wrap align-items-center gap-25 mb-3">
                                                <div class="h10_course-content-tag">
                                                    <a href="{{url('courses/abacus')}}">Abacus</a>
                                                </div>
                                                <div class="h10_course-content-rating">
                                                    <ul>
                                            ...
                                            {{-- <div class="h10_course-content-info">
                                                <ul>
                                                    <li><i class="fa-light fa-book-blank"></i>6 Lessons</li>
                                                    <li><i class="fa-light fa-user-group"></i>32 Students</li>
                                                </ul>
                                            </div> --}}
                                            <h5 class="h10_course-content-title"><a
                                                    href="{{url('courses/abacus')}}">Abacus & Arithmetic Training Course
                                                    for Kids</a>
                                            </h5>
                                            <div class="h10_course-content-btn">
                                                <a href="{{url('courses/abacus')}}">Enroll Course<i class="fa-light fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="h10_course-item mb-30">
                                    <div class="h10_course-item-top">
                                        <div class="h10_course-item-img">
                                            <a href="{{url('courses/vedic-math')}}"><img src="assets/img/course/10/4.jpg"
                                                    alt=""></a>
                                            <div class="h10_course-item-img-price">
                                                <span>Enroot Abacus</span>
                                            </div>
                                        ...
                                        <div class="h10_course-content">
                                            <div class="d-flex flex-wrap align-items-center gap-25 mb-3">
                                                <div class="h10_course-content-tag">
                                                    <a href="{{url('courses/vedic-math')}}">Vedic Math</a>
                                                </div>
                                                <div class="h10_course-content-rating">
                                                    <ul>
                                                        <li><i class="fa-solid fa-star"></i></li>
                                            ...
                                            <h5 class="h10_course-content-title"><a
                                                    href="{{url('courses/vedic-math')}}">Teaching Vedic Math
                                                    Inquiry-Based Approaches</a></h5>
                                            <div class="h10_course-content-btn">
                                                <a href="{{url('courses/vedic-math')}}">Enroll Course<i class="fa-light fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="h10_course-item mb-30">
                                    <div class="h10_course-item-top">
                                        <div class="h10_course-item-img">
                                            <a href="course-details.html"><img src="assets/img/course/10/7.jpg"
                                                    alt=""></a>
                                            <div class="h10_course-item-img-price">
                                                <span>Enroot Abacus</span>
                                            </div>
                                        ...
                                        <div class="h10_course-content">
                                            ...
                                            <h5 class="h10_course-content-title"><a href="course-details.html">Train
                                                    Your Child with Chess with our High Qualified Teachers</a></h5>
                                            <div class="h10_course-content-btn">
                                                <a href="#">View Course<i class="fa-light fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section-area-8 text-center mb-50">
                        <span class="section-subtitle">Choose Your Career</span>
                        <h2 class="section-title mb-0">Career Opportunities</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="h8_career-item mb-30">
                        ...
                        <div class="h8_career-item-content">
                            ...
                            <h4>Apply for Enroot Abacus Franchisee</h4>
                            <a href="{{url('/apply-franchise')}}" class="theme-btn theme-btn-8 h8_career-btn">Apply Now<i
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="h8_career-item mb-30">
                        ...
                        <div class="h8_career-item-content">
                            ...
                            <h4>Join Enroot Abacus as Our Student</h4>
...
{{--    
        <section class="h5_event-area pt-135 pb-140">
            <div class="container">
                ...
                <div class="row g-0">
                    <div class="col-xl-7">
                    <marquee scrollamount="10" behavior="scroll" direction="up">
                            ...
                            <div class="h5_event-item">
                                ...
                                <div class="h5_event-item-content pt-4 pb-4">
                                    <ul>
                                        ...
                                        <li><a href="#"><i class="fa-light fa-clock"></i>8.00 am - 6.00 pm</a></li>
                                    </ul>
                                    <h5><a href="event-details.html">These are Designed to Provide Hands and  Training Skill-Building.</a></h5>
                                </div>
                            </div>
                            <div class="h5_event-item">
                                ...
                                <div class="h5_event-item-content">
                                    ...
                                    <h5><a href="event-details.html">Personalized Learning Meeting The Needs of Every Student..</a></h5>
                                </div>
                            </div>
                            <div class="h5_event-item">
                                <div class="h5_event-item-date">
                                ...
                                <div class="h5_event-item-content">
                                    ...
                                    <h5><a href="event-details.html">The Whole Child Fostering Social and Emotional Development.</a></h5>
                                </div>
                            </div>
                        </div>
                    </marquee>
    ...
    <section class="h10_testimonial-area pt-90 pb-120 fix">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="h10_testimonial-title mb-35"><span><img src="assets/img/testimonial/10/shape-1.png"
                                alt="">O</span>
                        <strong class="waviy">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-6 col-lg-7 col-md-7">
                    <div class="h10_testimonial-wrap mr-45 position-relative">
                        <div class="h10_testimonial-active swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="h10_testimonial-item">
                                        <blockquote>
                                            <p>Myself Gopa Roy, proud to be a part of EAPL as a Business Partner for last 7 years with the desire to initiate my own business in education development. I started with my home centre at Agarpara and now extended with another fivecentres with major support by EAPL. In this pandemic situation also I could retain my student strength almost 87% within 310 students across Agarpara, Sodepur, Khardaha, Barrackpore, Birati and Palta with introducing online classes and other activities. Myself along with my students is very much satisfied with Team Enroot with their tremendous support, co-operation and new implementation of VedMaths and many other new courses</p>
                                            <div class="quote-admin-inner">
                                                <h5>MRS. GOPA ROY</h5>
                                                <span>Business Partner |

                                                    Agarpara, Sodepur, Khardaha,
                                ...
                                <div class="swiper-slide">
                                    <div class="h10_testimonial-item">
                                        <blockquote>
                                            <p>Enroot Abacus Pvt. Ltd. is way more than an institution to me. In our journey for last four years we have shared a close band and have evolved to be a great family that has braved as overwhelming a challenge as Covid and demonstrated an undaunted tenacity which would have been difficult indeed but for the precious guidance we received from our honorable ED, Mr Suklambar Mitra. We at Matrix would also like to express our sincere thanks to the entire team at Enroot who refusing to give in to the pandemic pressure continued to extend their much needed support in this trying time. Taking online classes with 195 students was not a cake walk and without their robust support we would have never made it this far. I am sure soon we will see them grow really really big and scale up their presence across the country.
                                            </p>
                                            <div class="quote-admin-inner">
                                                <h5>MR. AMIT PAUL.</h5>
                                                <span>Business Partner |

                                                    Bakhrahat, Amtala, Fatepur & Muchisa.
                                ...
                                <div class="swiper-slide">
                                    <div class="h10_testimonial-item">
                                        <blockquote>
                                            <p>As the head of an educational institute I always believe that students must get new age learning experience in my preschool environment and this is being offered successfully by Enroot Abacus. Their team offers personalized support at each and every stage. In addition the dedicated team ensures that our operational needs and queries are handled effectively. The parents are also very happy with their kid's performance. At present I am running 3 centers in West Bengal, Bongaon and Gobardanga and Thakurnagar
                                            </p>
                                            <div class="quote-admin-inner">
                                                <h5>MRS. MOUMITA PAL</h5>
                                                <span>Business Partner |Gobordanga, Bongaon & Thakurnagar
                                ...
                                <div class="swiper-slide">
                                    <div class="h10_testimonial-item">
                                        <blockquote>
                                            <p>At first I would like to congratulate ED, Mr. SuklombarMitra& Director, Mrs. Anindita Deb of Enroot Abacus Pvt Ltd for their outstanding contribution towards this fantastic Brain Development Program. Thereafter the thing which is crucial to mention is that 1, Mr. Pradip Ghosh as Director of Brain Power Computer Academy Kalna like to say many many congratulations to all the faculty members of Enroot Abacus for their tremendous support and hard work.l have been working with this independent organization for last 6 yrs with my full potential. Till the date I can proudly say that my Institution has produced so many champs in these last 4 yrs who have achieved several prizes in National Level Platform. Moreover, in current days my centre is running successfully with 450+ students. I do believe that I will be able to touch the milestone of 1000 students immediately.

                                            </p>
                                            <div class="quote-admin-inner">
                                                <h5>MR. PRADIP KUMAR GHOSH</h5>
                                                <span>Business Partner |Kalna, Magra & Memari
                                ...
                                <div class="swiper-slide">
                                    <div class="h10_testimonial-item">
                                        <blockquote>
                                            ...
                                            <div class="quote-admin-inner">
                                                <h5>MRS. PALLABI CHAKRABORTY</h5>
                                                <span>Business Partner |Darjeeling and Jalpaiguri
                                ...
                                <div class="swiper-slide">
                                    <div class="h10_testimonial-item">
                                        <blockquote>
                                            <p>I am thrilled to let you know that I am with Enroot Abacus since 2014 and I have to say that there is no better way than to rely on Enroot for the development of abacus skill along with heightened concentration. Now I have 100+ students. It's really pleasing to find them excel in Mathematics and other subjects. Huge thanks to Enroot Abacus for their whole-hearted support for making the dream comes true.

                                            </p>
                                            <div class="quote-admin-inner">
                                                <h5>MR. SANTANU SARKAR</h5>
                                                <span>Business Partner |Shyamnagar
                            ...
                            <div class="h10_testimonial-navigation">
                                <div class="h10_testimonial-prev">
                                ...
                                <div class="h10_testimonial-next">
                                    <svg width="10" height="16" viewBox="0 0 10 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.5 8L2 0.5L0.950001 1.55L7.4 8L0.950001 14.45L2 15.5L9.5 8Z"
                                            fill="currentColor" />
                                        <path d="M9.5 8L2 0.5L0.950001 1.55L7.4 8L0.950001 14.45L2 15.5L9.5 8Z"
                        ...
                        <div class="h10_testimonial-thumb-wrap">
                            <div class="h10_testimonial-thumbs swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="h10_testimonial-admin">
                                            <img src="assets/img/enroot/enrootlogo-ft.png" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="h10_testimonial-admin">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5">
                    <div class="h10_testimonial-img ml-10 w_img">
                        <img src="assets/img/testimonial/10/1.png" alt="" class="wow fadeInRight"
                            data-wow-delay="0.3s">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="h6_cta-wrapper" data-background="assets/img/cta/7/bg.jpg">
                ...
                <div class="h6_cta-button">
                    <a href="{{url('/apply-franchise')}}" class="h6_cta-btn">Get Franchisee Now<i class="fa-light fa-arrow-up-right"></i></a>
                </div>
            </div>
        </div>
    </div>
