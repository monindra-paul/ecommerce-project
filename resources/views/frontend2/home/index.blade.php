        ...
        <div class="banner-slider box-arrow">
            ...
            <div class="banner-poster">
                        ...
                        <ul class="label-15">
                            <li>
                                <a href="https://www.facebook.com/">
                                    <img src="{{asset('frontend/assets/images/social-icon/1.png')}}"
                                        class="img-fluid blur-up lazyload" alt="facebook">
                                    <h5 class="d-lg-block d-none">Facebook</h5>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/">
                                    <img src="{{asset('frontend/assets/images/social-icon/2.png')}}"
                                        class="img-fluid blur-up lazyload" alt="Instagram">
                                    <h5 class="d-lg-block d-none">Instagram</h5>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/">
                                    <img src="{{asset('frontend/assets/images/social-icon/3.png')}}"
                                        class="img-fluid blur-up lazyload" alt="Twitter">
                ...
                <div class="slider-bg">
                    ...
                    <img src="{{asset('frontend/assets/images/shoes/1-.png')}}"
                        class="shoes-1 img-fluid blur-up lazyload" alt="">
                </div>
                ...
                <div class="sugestion-product d-xl-block d-none">
                    ...
                    <a href="product-left-sidebar.html" class="slider-shoes-image d-block">
                        <div class="relative-shoes">
                            <img src="{{asset('frontend/assets/images/shoes/slider-2.png')}}"
            ...
            <div class="banner-poster">
                ...
                <div class="slider-bg">
                    ...
                    <img class="shoes-1 img-fluid blur-up lazyload" alt=""
                        src="{{asset('frontend/assets/images/shoes/slider-2.png')}}">
                </div>
                ...
                <div class="sugestion-product d-xl-block d-none">
                    ...
                    <a href="product-left-sidebar.html" class="slider-shoes-image d-block">
                        <div class="relative-shoes">
                            <img src="{{asset('frontend/assets/images/shoes/Slider.png')}}"
                                class="img-fluid blur-up lazyload" alt="">
                            <div class="shoes-price">
                                <h5>$49.00</h5>
                                <h6>Nike Shoes</h6>
            ...
            <div class="banner-poster">
                ...
                <div class="slider-bg">
                    ...
                    <img class="shoes-1 img-fluid blur-up lazyload" alt=""
                        src="{{asset('frontend/assets/images/shoes/Slider.png')}}">
                </div>
        ...
        <div class="row g-4 g-sm-3">
            <div class="col-xl-3 col-sm-6">
                <div class="service-wrap">
                    <div class="service-icon">
                        <svg>
                            <use xlink:href="{{asset('frontend/assets/svg/icons.svg#customer')}}"></use>
                        </svg>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="service-wrap">
                    <div class="service-icon">
                        <svg>
                            <use xlink:href="{{asset('frontend/assets/svg/icons.svg#shop')}}"></use>
                        </svg>
                    </div>
                    <div class="service-content">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="service-wrap">
                    <div class="service-icon">
                        <svg>
                            <use xlink:href="{{asset('frontend/assets/svg/icons.svg#secure-payment')}}"></use>
                        </svg>
                    </div>
                    <div class="service-content">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="service-wrap">
                    <div class="service-icon">
                        <svg>
                            <use xlink:href="{{asset('frontend/assets/svg/icons.svg#return')}}"></use>
                        </svg>
                    </div>
                    <div class="service-content">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="poster-image">
                        <img src="{{asset('frontend/assets/images/shoes/poster/1.png')}}"
                ...
                <div class="col-lg-6 mt-lg-0 mt-4">
                    <div class="poster-image">
                        <img src="{{asset('frontend/assets/images/shoes/poster/2.png')}}"
                            class="img-fluid bg-img blur-up lazyload" alt="">
                        <div class="poster-image-details">
                            <div>
                        ...
                        <div class="product-box">
                                ...
                                <a href="product-left-sidebar.html">
                                    ...
                                    <a href="{{route('products.edit',$product->id)}}">
                                        <img src="{{asset('uploads/product/small/'.$productImage->image)}}"
                                            class="bg-img img-fluid blur-up lazyload" alt="product">
                                    </a>
                                    @else
                                    <a href="{{route('products.edit',$product->id)}}">
                                        <img src="{{asset('admin/img/product-1.jpg')}}"
                                            lass="bg-img img-fluid blur-up lazyload" alt="product">
                                    </a>
                                    @endif
                            ...
                            <div class="product-details text-center">
                                <h3 class="theme-color">
                                    ...
                                    <span class="font-light ml-1">₹ {{$product->compare_price}}</span>
                                    @endif
                                </h3>
            ...
            <div class="col-lg-6 ratio2_1">
                <div class="collection-banner p-right text-right">
                    <a href="shop-left-sidebar.html" class="banner-img">
                        <img src="{{asset('frontend/assets/images/shoes/poster-2/1.jpg')}}"
                ...
                <div class="row gy-4">
                    <div class="col-lg-12 ratio_40">
                        <div class="collection-banner p-left banner-title">
                            <a href="shop-left-sidebar.html" class="banner-img">
                                <img src="{{asset('frontend/assets/images/shoes/poster-2/2.jpg')}}"
                                    class="bg-img blur-up lazyload" alt="">
                            </a>
                    ...
                    <div class="col-md-6 ratio2_3">
                        <div class="collection-banner p-center text-center">
                            <a href="shop-left-sidebar.html" class="banner-img">
                                <img src="{{asset('frontend/assets/images/shoes/poster-2/3.jpg')}}"
                                    class="bg-img blur-up lazyload" alt="">
                            </a>
                    ...
                    <div class="col-md-6 ratio2_3">
                        <div class="collection-banner p-center text-center">
                            <a href="shop-left-sidebar.html" class="banner-img">
                                <img src="{{asset('frontend/assets/images/shoes/poster-2/4.jpg')}}"
                                    class="bg-img blur-up lazyload" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="category-wrap category-color">
                        <a href="shop-category-slider.html">
                            ...
                            <img src="{{asset('uploads/category/thumb/'. $category->image)}}"
                                class="img-fluid blur-up lazyload" alt="category image">
                            @endif

                        </a>
                    </div>
                    <a href="#">
                        <div class="category-content category-text t-text text-center mt-4">
                            <h3>{{$category->name}}</h3>
                            {{-- <span>$45 - $80</span> --}}
                        </div>
                    </a>
                ...
                <div class="brand-slider">
                    <div>
                        <div class="brand-image">
                            <img src="{{asset('frontend/assets/images/brand/1.png')}}"
                                class="img-fluid blur-up lazyload" alt="brand logo">
                        </div>
                    </div>
                    <div>
                        <div class="brand-image">
                            <img src="{{asset('frontend/assets/images/brand/2.png')}}"
                                class="img-fluid blur-up lazyload" alt="brand logo">
                        </div>
                    </div>
                    <div>
                        <div class="brand-image">
                            <img src="{{asset('frontend/assets/images/brand/3.png')}}"
                                class="img-fluid blur-up lazyload" alt="brand logo">
                        </div>
                    </div>
                    <div>
                        <div class="brand-image">
                            <img src="{{asset('frontend/assets/images/brand/4.png')}}"
                                class="img-fluid blur-up lazyload" alt="brand logo">
                        </div>
                    </div>
                    <div>
                        <div class="brand-image">
                            <img src="{{asset('frontend/assets/images/brand/5.png')}}"
                                class="img-fluid blur-up lazyload" alt="brand logo">
                        </div>
                    </div>
                    <div>
                        <div class="brand-image">
                            <img src="{{asset('frontend/assets/images/brand/6.png')}}"
                                class="img-fluid blur-up lazyload" alt="brand logo">
                        </div>
                    </div>
                    <div>
